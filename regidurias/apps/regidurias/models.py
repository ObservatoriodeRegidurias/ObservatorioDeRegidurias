...
class Regidurias(models.Model):
    ...
    genero = models.CharField(max_length=1,default=1, choices=GENERO_CHOISES, verbose_name='Género')
    ...
    correo = models.CharField(max_length=120, blank=True, null=True, verbose_name='Correo')
